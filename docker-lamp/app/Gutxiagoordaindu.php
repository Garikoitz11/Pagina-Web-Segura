...
<script type="text/javascript">
    ...
    ?>
        ...
        <main>
            <div class="titulillos"> Pentsatzen duzuna baino askoz gutxiago ordaindu</div>
            <div class="texto">Beste denda askotan baino askoz gutxiago ordainduko duzu. Izan ere, beherapen eta eskaintza ezinhobeak ditugu, zure gustukoak izango direnak seguruenik.</div>
        </main>
        <footer>
            <div class="copyright">
