        ...
        <main class="main">
            <div class="container">
                <div class="column menu">
                    <nav>
                        <ul>
                            <li><a href="index.html" target="_self">Gure produktuak</a></li>        
                            <li><a href="produktuakKontsultatu.php" target="_self">Erabiltzaileen produktuak</a></li>
                            <li><a href="sartuProduktua.html" target="_self">Sartu produktuak</a></li>
                        </ul>
                    </nav>
                </div>
            </div>
            ...
            <section>
                <div class="products-list">
                    <div class="ventajas">
                        <a href="Gutxiagoordaindu.html" target="_self"><img src="irudiak/Argazkia1.jpg" alt="Gutxiago ordaindu"></a>
                    </div>
                    <div class="ventajas">
                        <a href="Bidalketadoan.html" target="_self"><img src="irudiak/Argazkia2.jpg" alt="Bidalketa doan"></a>
                    </div>
                    <div class="ventajas">
                        <a href="2urte.html" target="_self"><img src="irudiak/Argazkia3.jpg" alt="2 urteko garantia"></a>
                    </div>
                    <div class="ventajas">
                        <a href="Ordainketasegurua.html" target="_self"><img src="irudiak/Argazkia4.jpg" alt="Ordainketa segurua"></a>
                    </div>
                </div>
            </section>
            <hr>
