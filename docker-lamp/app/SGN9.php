...
<script type="text/javascript">
    ...
    ?>
        ...
        <main> 
        <div class="titulo"> SAMSUNG GALAXY NOTE 9</div>
        
        <nav class="columnas">   
        <p> <div class="foto"><img src="irudiak/sgnote9.jpg" width="250px" alt="Samsung Galaxy Note 9"> </div></p>
        <p>
        <div class="cuerpo1"><strong>Sistema operatiboa:</strong>&nbsp;Android</div>
        <div class="cuerpo"><strong>Ram:</strong>&nbsp;8GB</div>
        <div class="cuerpo"><strong>Prezioa:</strong>&nbsp;449€</div><br>
